<template>
  <div class="q-pa-md relative">
    ...
    <a
      ...
      @click.prevent="openTwoUnit"
    >
      <i class="fas fa-edit"></i>
    </a>
  </div>
  <TwoUnitModal ref="twoUnitModal" />
...
<script>
import TwoUnitModal from "src/pages/UnitSelectModal/TwoUnitModal.vue";
import { ref } from "vue";
...
export default {
  ...
  methods: {
    openTwoUnit() {
      this.$refs.twoUnitModal.openTwoUnit();
    },
  },
};
</script>
